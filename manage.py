...
def deploy():
    ...
    course3 = Course(number="ECON301",title='Quantitative Microeconomic Theory', description='Uses calculus to study price determination and income distribution in a market economy; and the behavior of firms and industry under conditions of pure and imperfect competition.')
    course4 = Course(number="MISY225",title='Introduction to Programming Business Applications', description='Use of higher level contemporary computing languages to structure Prototyping applications of systems.')
